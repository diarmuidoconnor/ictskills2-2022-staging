...
Now, log in to Moodle and locate the area concerned with this module. Click the link titled 'Submit FSD2 lab repo' and upload a simple text file (labwork.txt) containing the URL of your new GitHub repository. These repositories will be assessed after the deadline for completing __all__ the labs in this four-part series.
