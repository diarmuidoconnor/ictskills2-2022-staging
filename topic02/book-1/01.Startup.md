...
Now, log in to [Moodle][moodle] and locate the area concerned with this module. Click the link titled 'Submit FSD2 lab repo' and upload a simple text file (labwork.txt) containing the URL of your new GitHub repository. These repositories will be assessed after completing __all__ the labs in this four-part series. You should upload the text file as part of this lab. For your information, the submission date on the upload link is the deadline for completing all the labs. 
