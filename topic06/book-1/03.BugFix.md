...
[ There are a few 'unused variable` warning messages coming from the transpiler as a result of the above changes (and some earlier changes). You can fix these by simply removing the offending declarations.]
